...
func TestDecode(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"-noLength",
			args{[]byte{0xfe, 0x00, 0x0e, 0x00, 0x01, 0xc0, 0x01, 0x02, 0x1e, 0x02, 0x60, 0x82, 0xff}},
			nil,
			true,
		},
		{
			"-malformedGlow",
			args{[]byte{0xfe, 0x00, 0x0e, 0x00, 0x01, 0xc0, 0x01, 0x02, 0x1e, 0x02, 0x60, 0x82, 0x01, 0xff}},
			nil,
			true,
		},
		{
