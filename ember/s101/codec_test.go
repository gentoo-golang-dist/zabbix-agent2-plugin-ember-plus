...
func TestDecode(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args{
				[]byte{
					0xa0, 0x29, 0x19, 0x91, 0x6f, 0x42, 0x30, 0xf7, 0x0d, 0x06, 0x5f, 0xff, 0x08, 0x00, 0x45, 0x00,
					0x00, 0x62, 0x00, 0x00, 0x40, 0x00, 0x3a, 0x06, 0x21, 0xdf, 0xac, 0x1e, 0x48, 0x0a, 0x0a, 0x34,
					0x20, 0x5b, 0x23, 0x29, 0xdd, 0xf6, 0xa3, 0xb7, 0xd8, 0xfd, 0x06, 0x11, 0x43, 0xac, 0x50, 0x18,
					0x00, 0x81, 0x69, 0x2f, 0x00, 0x00, 0xfe, 0x00, 0x0e, 0x00, 0x01, 0xc0, 0x01, 0x02, 0x14, 0x02,
					...
					0x43, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4b, 0x5e, 0xff,
				},
			},
			[]byte{
				0x60, 0x80, 0x6b, 0x80, 0xa0, 0x80, 0x69, 0x80, 0xa0, 0x07, 0x0d, 0x05, 0x01, 0x1d, 0x06, 0x02,
		...
		},
		{
			...
			args{
				[]byte{
					,
				},
			},
			[]byte{
...
func Test_getS101s(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			got := getS101s(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Fatalf("getS101s() = %s", diff)
			}
		})
	}
}
